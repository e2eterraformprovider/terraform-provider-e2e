...
- `plan` (String) It is the plan of which load balancer is going to launch. To find the plan, please refer to our [`API Documentation`](https://docs.e2enetworks.com/api/myaccount/#/paths/appliance-type/get)
...
- `region` (String) This is the region of your loadbalancer. This is the standard parameter name for specifying the deployment location.
- `location` (Optional, **Deprecated**) (String) **DEPRECATED**: Use 'region' instead. This parameter will be removed in version 3.0.0. Location where the loadbalancer will be created.
